...
const CurrentActivity = () => {
  ...
  const handleClickOk = () => {
    axios.post('https://toreadit.hbgtest.se/wp-json/TomoveitRestApi/v1/setDoneActivity', {
  ...
  const handleClickNo = () => {
    axios.post('https://toreadit.hbgtest.se/wp-json/TomoveitRestApi/v1/resetActivity', {
      pin: pin,
    },
    ).then(() => {
    }, (error) => {
